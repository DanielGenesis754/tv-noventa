const videos = [
            // URLs dos vÃ­deos de propagandas
...
"https://www.youtube.com/embed/QQ6v0S450rQ?autoplay=1&start=15&loop=1&playlist=QQ6v0S450rQ"
        ...
        const desenhosVideos = [
            // URLs dos vÃ­deos de desenhos animados
...
"https://www.youtube.com/embed/pFCkVf3aiOI?autoplay=1&start=15&loop=1&playlist=pFCkVf3aiOI"
        ...
        function playNextVideo() {
            ...
            if (nextVideo.url) {
                ...
                setTimeout(() => {
                    videoFrame.innerHTML = ''; // Limpa o conteÃºdo anterior
                ...
                }, 1000); // Tempo da estÃ¡tica antes de trocar o vÃ­deo
            }
